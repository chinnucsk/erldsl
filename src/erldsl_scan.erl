-file("/home/xandox/erlang/R14B04/lib/erlang/lib/parsetools-2.0.6/include/leexinc.hrl", 0).
...
-file("/home/xandox/erlang/R14B04/lib/erlang/lib/parsetools-2.0.6/include/leexinc.hrl", 14).
...
-file("./erldsl_scan.xrl", 57).
yyaction_7(TokenChars, TokenLen, TokenLine) ->
     Cs = string : substr (TokenChars, 3, TokenLen - 4),
     long_bracket (TokenLine, Cs) .

-compile({inline,yyaction_8/1}).
-file("./erldsl_scan.xrl", 62).
yyaction_8(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("./erldsl_scan.xrl", 63).
yyaction_9(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("./erldsl_scan.xrl", 64).
yyaction_10(TokenLine) ->
     { token, { '*', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("./erldsl_scan.xrl", 65).
yyaction_11(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_12/1}).
-file("./erldsl_scan.xrl", 66).
yyaction_12(TokenLine) ->
     { token, { '%', TokenLine } } .

-compile({inline,yyaction_13/1}).
-file("./erldsl_scan.xrl", 67).
yyaction_13(TokenLine) ->
     { token, { '^', TokenLine } } .

-compile({inline,yyaction_14/1}).
-file("./erldsl_scan.xrl", 68).
yyaction_14(TokenLine) ->
     { token, { '#', TokenLine } } .

-compile({inline,yyaction_15/1}).
-file("./erldsl_scan.xrl", 69).
yyaction_15(TokenLine) ->
     { token, { '==', TokenLine } } .

-compile({inline,yyaction_16/1}).
-file("./erldsl_scan.xrl", 70).
yyaction_16(TokenLine) ->
     { token, { '~=', TokenLine } } .

-compile({inline,yyaction_17/1}).
-file("./erldsl_scan.xrl", 71).
yyaction_17(TokenLine) ->
     { token, { '<=', TokenLine } } .

-compile({inline,yyaction_18/1}).
-file("./erldsl_scan.xrl", 72).
yyaction_18(TokenLine) ->
     { token, { '>=', TokenLine } } .

-compile({inline,yyaction_19/1}).
-file("./erldsl_scan.xrl", 73).
yyaction_19(TokenLine) ->
     { token, { '<', TokenLine } } .

-compile({inline,yyaction_20/1}).
-file("./erldsl_scan.xrl", 74).
yyaction_20(TokenLine) ->
     { token, { '>', TokenLine } } .

-compile({inline,yyaction_21/1}).
-file("./erldsl_scan.xrl", 75).
yyaction_21(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_22/1}).
-file("./erldsl_scan.xrl", 76).
yyaction_22(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_23/1}).
-file("./erldsl_scan.xrl", 77).
yyaction_23(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_24/1}).
-file("./erldsl_scan.xrl", 78).
yyaction_24(TokenLine) ->
     { token, { '{', TokenLine } } .

-compile({inline,yyaction_25/1}).
-file("./erldsl_scan.xrl", 79).
yyaction_25(TokenLine) ->
     { token, { '}', TokenLine } } .

-compile({inline,yyaction_26/1}).
-file("./erldsl_scan.xrl", 80).
yyaction_26(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_27/1}).
-file("./erldsl_scan.xrl", 81).
yyaction_27(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_28/1}).
-file("./erldsl_scan.xrl", 82).
yyaction_28(TokenLine) ->
     { token, { '::', TokenLine } } .

-compile({inline,yyaction_29/1}).
-file("./erldsl_scan.xrl", 83).
yyaction_29(TokenLine) ->
     { token, { ';', TokenLine } } .

-compile({inline,yyaction_30/1}).
-file("./erldsl_scan.xrl", 84).
yyaction_30(TokenLine) ->
     { token, { ':', TokenLine } } .

-compile({inline,yyaction_31/1}).
-file("./erldsl_scan.xrl", 85).
yyaction_31(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_32/1}).
-file("./erldsl_scan.xrl", 86).
yyaction_32(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_33/1}).
-file("./erldsl_scan.xrl", 87).
yyaction_33(TokenLine) ->
     { token, { '..', TokenLine } } .

-compile({inline,yyaction_34/1}).
-file("./erldsl_scan.xrl", 88).
yyaction_34(TokenLine) ->
     { token, { '...', TokenLine } } .

-compile({inline,yyaction_35/0}).
-file("./erldsl_scan.xrl", 90).
yyaction_35() ->
     skip_token .

-compile({inline,yyaction_36/0}).
-file("./erldsl_scan.xrl", 93).
yyaction_36() ->
     skip_token .

-compile({inline,yyaction_37/0}).
-file("./erldsl_scan.xrl", 95).
yyaction_37() ->
     skip_token .

-file("/home/xandox/erlang/R14B04/lib/erlang/lib/parsetools-2.0.6/include/leexinc.hrl", 282).
